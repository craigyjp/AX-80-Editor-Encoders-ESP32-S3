...
void settingsLoadRAM(int index, const char *value) {
  loadRAM = (strcmp(value, "Yes") == 0);
  storeLoadRAM(loadRAM ? 1 : 0);
}
...
//     peekMode = false;
//   }
//   storePeekMode(peekMode ? 1 : 0);  // delegate EEPROM write
// }
...
int currentIndexEncoderAccelerate() {
  return getEncoderAccelerate() ? 1 : 0;  // “Yes” = 1, “No” = 0
}
...
int currentIndexLoadRAM() {
  return getLoadRAM() ? 1 : 0;   // “Yes” = 1, “No” = 0
}
